...
public class AstExpBinop extends AstExp {
	...
	public Type semantMe() throws SemanticException {
		...
		// semant operands
		if (left != null)
			t1 = leftType = left.semantMe();
		if (right != null)
			t2 = rightType = right.semantMe();
			...
			case EQ:
				if (leftType instanceof TypeString || rightType instanceof TypeString) {
					Ir.getInstance().AddIrCommand(new IrCommandBinopEqStrings(dst, t1, t2));
						...
						||
						rightType instanceof TypeClass || rightType instanceof TypeArray
						|| rightType instanceof TypeNil) {
